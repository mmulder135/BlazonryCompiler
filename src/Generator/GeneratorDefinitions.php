...
class GeneratorDefinitions
{
    const BASESHIELD = '
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="600" height="660" id="Shield">
            ...
            <g>
                <use style="stroke:#000000" id="Field" xlink:href="#Shield1"/>
            </g></svg>
    ';
    ...
    static public function getColor(string $color): ?string
    {
    ...
    static public function getFurDefinition(string $fur): ?string
    {
    ...
    static public function getPartitionMask(string $partition): ?string
    {
